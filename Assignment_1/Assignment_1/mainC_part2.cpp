// ---------------------------------------------------------------------------
// CS 2C Assignment #1 Part C - Extra Credit (iTunes)
#include <iostream>
#include <vector>
#include <ctime>
#include "iTunes.h"
...
int main()
{
   ...
   Sublist<iTunesEntry> empty(&dataSet);
...
/* ----------------------- runs -----------------------
 ...
 Algorithm Elapsed Time: 9.9e-05 seconds.
 ...
 Algorithm Elapsed Time: 0.015059 seconds.
 ...
 Algorithm Elapsed Time: 3.84949 seconds.
 ...
 Algorithm Elapsed Time: 112.696 seconds.
 ...
 Algorithm Elapsed Time: 0.002524 seconds.
